# import threading
# def welcome():
#     print(f"It Is Welcome Function:{threading.current_thread().name}")

# def hello():
#     print(f"It Is Hello Function:{threading.current_thread().name}")    

# def hi():
#     print(f"hi function:{threading.current_thread().name}")
